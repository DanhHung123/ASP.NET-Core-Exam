    ...
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Employee != null ? 
                          ...
                          Problem("Entity set 'EmployeeCrudContext.Employee'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeID,EmployeeName,Department,Salary")] Employee employee)
        {
